	...
	{
		{
			...
			(
				...
				#(async
				{
					<_ as compute_graph::service_handle::ServiceHandle <_>>::exit_status (&mut services . #service_idx)
						. await
			...
			)
			{
				...
				{
					#(<_ as compute_graph::service_handle::ServiceHandle <_>>::shutdown (&mut services . #service_idx);)*
